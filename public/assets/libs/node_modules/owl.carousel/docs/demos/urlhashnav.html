...
<head>
    ...
    <meta content="Url Hash Navigation usage demo" name="description">
...
<section id="demos">
    <div class="row">
        <div class="large-12 columns">
            ...
            <blockquote>
                <p>URLhashListener option is listening for url hash change and is looking for slide with the same data
                    name e.g. <code>data-hash=&quot;zero&quot;</code></p>
            </blockquote>
            <p>Also <code>startPosition</code> option accept string: <code>&#39;URLHash&#39;</code>. This will load
                corresponding items on startup. Browser history back button is also affected.</p>
