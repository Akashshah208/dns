    ...
    <div class="row">
        ...
        <div class="small-12 medium-9 large-9 columns">
            <article class="docs-content">
                ...
                <p>Owl Carousel 2.x.x is not compatibile with previous version 1.x.x. The idea stays the same and it has
                    a lot in common with Owl1 but the core code was re-written from scratch and I’m very proud with all
                    the new features.</p>
                ...
                <ul>
                    <li><a href="https://github.com/OwlCarousel2/OwlCarousel2/archive/2.3.4.zip">Owl Carousel -
                        2.3.4</a> - Distributed version - compiled and minified. Javascript, images and CSS included.
                    </li>
                    <li><a href="https://github.com/OwlCarousel2/OwlCarousel2/archive/master.zip">Owl Carousel Source -
                        2.3.4</a> - Source files including this documentation. All wrapped in Grunt project.
                    </li>
                </ul>
...
└── README.md</code></pre>
                ...
                <p>Get the latest
                    ...
                    <a href="http://zeptojs.com/">Zepto</a> library. Minimum compatible jQuery version is 1.8.3 version.
                </p>
