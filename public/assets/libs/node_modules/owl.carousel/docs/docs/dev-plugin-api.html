    ...
    <div class="row">
        ...
        <div class="small-12 medium-9 large-9 columns">
            <article class="docs-content">
                ...
                <blockquote>
                    <p>Plugin API allows you to extend carousel object constructor and use internal functions and
                        variables. Use callback events to communicate between host and plugin.</p>
                </blockquote>
