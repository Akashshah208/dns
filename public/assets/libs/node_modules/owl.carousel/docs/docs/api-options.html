    ...
    <div class="row">
        ...
        <div class="small-12 medium-9 large-9 columns">
            <article class="docs-content">
                ...
                <p>Type: <code>Boolean</code>
                    <br/> Default: <code>false</code></p>
                <p>Lazy load images. data-src and data-src-retina for highres. Also load images into background inline
                    style if element is not &lt;img&gt;</p>
                <hr>
                <h4 id="lazyloadeager">lazyLoadEager</h4>
                <p>Type: <code>Number</code>
                    <br/> Default: <code>0</code></p>
                <p>Eagerly pre-loads images to the right (and left when loop is enabled) based on how many items you
                    want to preload.</p>
                <hr>
                ...
                <p>Set on any DOM element. If you care about non responsive browser (like ie8) then use it on main
                    wrapper. This will prevent from crazy resizing.</p>
                <hr>
                ...
                <p>Type: <code>Function</code>
                    <br/> Default: <code>false</code></p>
                <p>Callback to retrieve basic information (current item/pages/widths). Info function second parameter is
                    Owl DOM object reference.</p>
                <hr>
                <h4 id="nesteditemselector">nestedItemSelector</h4>
                <p>Type: <code>String/Class</code>
                    <br/> Default: <code>false</code></p>
                <p>Use it if owl items are deep nested inside some generated content. E.g &#x27;youritem&#x27;. Dont use
                    dot before class name.</p>
                <hr>
                ...
                <p>Type: <code>Boolean</code>
                    <br/> Default: <code>true</code></p>
                <p>If you know the carousel will always be visible you can set &#x60;checkVisibility&#x60; to &#x60;false&#x60;
                    to prevent the expensive browser layout forced reflow the $element.is(&#x27;:visible&#x27;)
                    does.</p>
                <hr>
