    ...
    <div class="row">
        ...
        <div class="small-12 medium-9 large-9 columns">
            <article class="docs-content">
                ...
                <blockquote>
                    <p>Why not try Owl with other fantastic open source libraries? Check the list of plugins I&#39;ve
                        used in some of the demos.</p>
                </blockquote>
                <h3 id="animate-css">animate.css</h3>
                <p>This is an awesome library created by Daniel Eden of CSS3 animations that perfectly works with
                    animate functions.</p>
                <ul>
                ...
                <p>A jQuery plugin created by Brandon Aaron that adds cross-browser mouse wheel support with delta
                    normalization.</p>
                <ul>
                    <li><a href="https://github.com/brandonaaron/jquery-mousewheel">Visit jQuery Mousewheel website</a>
                    </li>
